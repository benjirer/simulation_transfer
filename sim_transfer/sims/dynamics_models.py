...
from sim_transfer.sims.spot_sim_config import SPOT_STATE_LENGTH, SPOT_ACTION_LENGTH, SPOT_ANGLE_IDX
...
class SpotDynamicsModel(DynamicsModel):
    ...
    def reduce_x(self, x):
        x_reduced = decode_angles_spot(x, self.angle_idx)
        return x_reduced

    def expand_x(self, x):
        x_expanded = encode_angles_spot(x, self.angle_idx)
        return x_expanded
